...
<body class="f-color">
    ...
    <div class="container w-75 my-5">
        <h2>Form Posting Kos</h2>
        <form method="POST" action="{{ url('formtambahkos') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="my-5">
            <input name="fjenis" type="hidden" value="kos">
                <table cellpadding="5" class="">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="radio" name="fstatus_kamarmandi" id="radioLuar" value="Luar" required/>
